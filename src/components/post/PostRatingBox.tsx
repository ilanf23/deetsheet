...
const PostRatingBox = ({ postId, averageRating, ratingCount, onRatingChanged }: PostRatingBoxProps) => (
  <div className="shrink-0 flex items-stretch rounded-lg border border-border bg-card px-4 py-3 gap-2 min-w-[260px]">
    ...
    <div className="w-1 self-stretch bg-border rounded-full mx-2" aria-hidden />
    <div className="flex-1 flex flex-col items-center justify-center">
