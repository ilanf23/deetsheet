  ...
  try {
    ...
    if (mode === "comments" || mode === "all") {
      ...
      function getGenericComments(topicName: string): string[] {
        return [
          `This nails something I've been trying to articulate for years about ${topicName}. The conventional advice gets you about 70% of the way there, the rest comes from personal experience and adaptation. What worked for me was starting with the standard approach, then systematically adjusting based on what I noticed in my own situation. Everyone's circumstances are different, so the cookie-cutter recommendations need modification. Keep a journal of what you're trying and what results you're seeing. Over time, patterns emerge that are unique to you, and those patterns become your real guide. I spent six months refining my approach this way and the difference was night and day.`,
          `Respectfully disagreeing with part of this, and I think the nuance matters. The overall direction is right, but there's a middle ground that gets overlooked. When I first got into ${topicName}, I went all-in on one approach and it backfired. Then I swung to the opposite extreme and that didn't work either. What finally clicked was taking elements from both philosophies and building a hybrid that fit my specific circumstances. We do a disservice to newcomers when we present things as black-and-white. Real life is messy. The best advice acknowledges that complexity instead of pretending there's one right answer.`,
          `Thank you for writing this so thoroughly. I shared it with three friends dealing with ${topicName} in different ways and every one of them found it valuable. The mental and emotional side really resonated, most resources focus entirely on the practical steps and ignore the psychological component, which in my experience is actually the harder part. I went through a period where I knew exactly what I should be doing but couldn't bring myself to do it because of fear and overthinking. What broke the cycle was finding a mentor who had been through it and could normalize the emotional roller coaster. Hearing 'yeah, that's normal and here's how I got through it' beats any how-to guide.`,
          `Coming at this from a slightly different angle, the timing aspect doesn't get discussed enough. When you encounter ${topicName} matters enormously in terms of how you process it and what strategies work. If you're early in your journey, the approach is fundamentally different than if you've been at it for years. I made the mistake of applying advanced strategies as a beginner, which led to frustration and self-doubt. Conversely, once I had more experience, the beginner advice felt patronizing. The missing piece is a clear framework for where you are in your journey and what's appropriate for that stage.`,
          `What I appreciate most here is the honesty. Too many forums around ${topicName} are echo chambers where everyone agrees with the prevailing wisdom and dissent is discouraged. The reality is this is a complex topic with legitimate debate and multiple valid approaches. I've tried three different strategies over the past two years and all of them had merits and drawbacks. The first was faster but less sustainable. The second was thorough but time-consuming. The third was a compromise but required resources not everyone has. I ultimately settled on a rotation, using different approaches based on my energy and priorities. The flexible framework has been far more effective than rigidly committing to any single method.`,
          `Picking up on what a few others said, the part about consistency over intensity is the single most underrated principle in ${topicName}. I wasted years chasing intensity. I'd go hard for a month, burn out, take three months off, then convince myself the answer was even more intensity next round. The unlock was permission to do less, every day, forever. The boring middle gear is where almost all the real progress lives. The people I admire most don't have superhuman willpower; they have very low standards for what counts as showing up, and they almost never miss.`,
          `Counterpoint to the top comment: I think this advice is good for the median person but actively harmful for a sizable minority. Some of us tried the moderate, sustainable, follow-your-instincts approach for years and got nowhere. What finally moved the needle on ${topicName} for me was a coach who set deadlines I would have called unreasonable, and a peer group that didn't let me hide. Sustainable is a virtue when you're already moving. When you're stuck, you sometimes need someone to break you out of the loop. The 'just be patient with yourself' advice can be a comfortable cage.`,
          `New to ${topicName} and reading this thread end to end, I'm honestly more confused than when I started, but in a useful way. I came in looking for the one right answer. What I'm taking away is that the right answer is the one I'll actually keep doing. Saving this post and the top three comments to come back to in three months once I have my own data to compare against. Question for the room: when you were just starting out, what's the single thing you wish someone had told you to ignore?`,
          `Replying to the question above, ignore the gear, the apps, the elaborate trackers, the optimization content. For my first year with ${topicName}, anything that wasn't direct practice was a distraction dressed up as preparation. I had a beautiful Notion dashboard and zero results. I deleted the dashboard, kept a paper sticky note with one number on it, and made more progress in three months than the previous twelve. The fluff feels like work because it's effortful and visible. Real progress is usually quiet and unphotogenic.`,
          `As someone who's been in the ${topicName} world professionally for over a decade, I want to push back on a romanticized version of this story that's circulating. People describe it as a linear arc, struggle, breakthrough, mastery, and that's not how it works in practice. It's spirals. You revisit the same lessons at deeper levels every few years. The thing you 'figured out' at year two will get reframed at year five and reframed again at year ten. Don't trust anyone who tells you they've fully mastered ${topicName}, including the version of yourself that thinks they have.`,
          `The financial / time-cost dimension nobody wants to talk about: serious engagement with ${topicName} is not cheap, even when the activity itself looks free on paper. There's the obvious money, but the bigger cost is the opportunity cost of the hours and the social cost of the relationships you don't fully invest in because this is taking your bandwidth. I'm not saying it isn't worth it, for me it absolutely has been, but I wish someone had been honest with me up front so I could have chosen with my eyes open. The 'just start, it's free' framing leaves out the real bill.`,
          `Lurker for a long time, finally posting. I want to add the survivorship-bias caveat. The voices in ${topicName} threads like this are overwhelmingly people for whom things worked out. The people who tried the same approach and quit, or got injured, or went broke, or just didn't get the result, mostly aren't here to comment. That doesn't mean the advice is wrong, but when you're reading these threads, mentally adjust for the fact that you're hearing from a self-selected group of winners. Stay humble about the role of luck and circumstance.`,
        ];
      }
